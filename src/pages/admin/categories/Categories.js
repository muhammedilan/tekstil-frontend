      ...
      <div className="card">
        <div className="card-header border-0">
          <div className="row g-4">
            <Link to="/admin/create-category" className="col-sm-auto">
              <div>
                <div className="btn btn-success" id="addproduct-btn">
                  <i className="ri-add-line align-bottom me-1" /> Add Category
                </div>
              </div>
            </Link>
                  ...
                  <div className="gridjs-footer">
                    <div className="gridjs-pagination">
                      ...
                      >
                        ...
                        <b>{sliceEnd}</b> of <b>{categories?.length}</b> results
                      </div>
