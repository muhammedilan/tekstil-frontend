...
const UnConfirmedOrders = () => {
  ...
  useEffect(() => {
    axios.get("/order/0").then((res) => setOrders(res.data));
  }, []);
                      ...
                      <tbody className="gridjs-tbody">
                        {orders?.slice(sliceStart, sliceEnd).map((o) => (
                          <tr className="gridjs-tr">
                            ...
                            <td data-column-id="quantity" className="gridjs-td">
                            ...
                            <td data-column-id="action" className="gridjs-td flex items-center gap-x-2 gap-y-1 flex-wrap justify-center">
                              <button
                                onClick={() => {
                                  axios
                                    .patch("/order", {
                                ...
                                className="p-1 bg-[#00a000] rounded-[4px]"
                              >
                                <TiTick size={18} color="#fff" />
                              </button>
                              <button
                                onClick={() => {
                                  axios
                                ...
                                className="p-1 bg-[#ff0000] rounded-[4px]"
                              >
